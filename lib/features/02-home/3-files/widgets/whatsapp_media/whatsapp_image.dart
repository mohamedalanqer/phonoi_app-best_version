...
import 'package:phonoi_app/features/02-home/3-files/widgets/whatsapp_media/whatsapp_video.dart';
...
class _WhatsappImageState extends State<WhatsappImage> with SingleTickerProviderStateMixin {
                ...
                Padding(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      final dates = assetsByDate.keys.toList()..sort((a, b) => b.compareTo(a));
...
class _ImageScreenState extends State<ImageScreen> {
  ...
  List<AssetEntity> imagesList = []; // إنشاء قائمة جديدة للصور
  bool _imageDeleted = false;

  @override
  void initState() {
    super.initState();
    print("*******************************************${widget.assetsByDate.length}");
  }
