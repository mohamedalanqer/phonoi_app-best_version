...
class _GalleryViewerScreenState extends State<GalleryViewerScreen> {
  ...
  bool _isAssetAlreadyAdded(Map<DateTime, List<AssetEntity>> assetsByDate, AssetEntity asset) {
    // Loop through existing assets and check if asset is already added
    for (var assetsList in assetsByDate.values) {
